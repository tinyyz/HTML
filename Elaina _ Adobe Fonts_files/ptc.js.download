...
ClickTaleGlobal.scripts.versions = {"wr": "bridge-WR110.js", "pcc": "df7e164d-c711-4376-a4c8-8b364d648be0.js?DeploymentConfigName=Release_20221129&Version=1"};
ClickTaleGlobal.scripts.sri = {};
ClickTaleGlobal.scripts.sri.path = "https://cdnssl.clicktale.net/ss/4451/df7e164d-c711-4376-a4c8-8b364d648be0/19/";
ClickTaleGlobal.scripts.sri.hashes = {"wr":"sha512-bNbXQ49S+YZ24YnV96jB1hhvXEUG3vaJ9IzWxjmHPQLUTmz7wT1mKNdcHxnzgOzcQ7g11bQZP7gv5XWDIfiU4g==","pcc":"sha512-MMQwBbAvN1cQGFxJslu9jMd+Giyi7NMOZ2KdG3FFSrbBE7BUTmio4BOCwqF0hBjiMW0904il0NfH96KAdXvgXw=="};
(function (d) {
	var dom="h",
	...
	ClickTaleGlobal.init.isAllowed = (function() {
						var doms = ["HJyViHahHkViLhJVT","HkViLhJVT","HkViLLeJoHuNLhJVT","HkViLNVskTPuLhJVT","JVssLJahPwLyJLwaPVuZhJVT","JyLHaPcLhHkViLhJVT","kJhZaHNLhHJyViHahJVT","mVyBTZhHkViLhJVT","oLswehHkViLhJVT","PwLyJLwaPVuZhJVT","qwhTHyRLaVhJVT","THNLuaVhJVT","THyRLaVhJVT","woVaVZoVwhJVT","XBHsayPJZhJVT","ZaHNLhHJJVBuaZhHkViLhJVT","ZaHNLhHJyViHahHkViLhJVT","HkViLhJVT","ZaHNLhHkViLhJVT"];
...
if(!ClickTaleGlobal.init.pccRequested) {
	    ...
	    pccSrc += 'df7e164d-c711-4376-a4c8-8b364d648be0.js?DeploymentConfigName=Release_20221129&Version=1';
...
//IMP-6094
function setOverrideBtn(selector, prefix) {
    var elements = document.querySelectorAll(selector);
    Array.prototype.forEach.call(elements, function (el, i) {
        if (isVisible(el)) {
            var overrideAttr = prefix + "_id_" + i;
            el.setAttribute("data-cs-override-id", overrideAttr);
        }
    });
}
if (document.location.pathname === '/') {
    var btnSelector = '.video-Wrapper +div a[class*="spectrum"]';
    setOverrideBtn(btnSelector, 'visible-cta');
}
else if (document.location.pathname.toLowerCase() === '/creativecloud.html') {
    setOverrideBtn('[id*="id-"] a[class*="cta"]', 'visible-cta');
    setOverrideBtn('div.dexter-FlexContainer-Items div[id*="id-"].dexter-FlexContainer', 'visible-div');
}
...
//Signature:o3vXgzhWAvBkmji3Nrbq2i79fV56AvZrCcfBTj8VAzKkXOifQwngw3tNRm5MmYpKl/EzhdLe5PGUPdvLoVWlXdhutxRXvnyooEgXfcFhrB8R9ddm+27yxJ04gzxh21BTA029vVjdroWjDTWbuOmBl5gah6oyzdI9FKTJDflLLh4=
